...
class UserDetailsScreen extends StatelessWidget {
  ...
  UserDetailsScreen(this.authUserModel);
  @override
  Widget build(BuildContext context) {
    return Builder(
      builder: (context) {
        //SocialCubit.get(context).getUsersPosts(authUserModel.uId);
        print(SocialCubit.get(context).usersPost);
        print(SocialCubit.get(context).usersPostId);
        print(SocialCubit.get(context).likesOfUsers);
        print(authUserModel.uId);
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                image: DecorationImage(
                                  image: NetworkImage('${authUserModel.cover}'),
                                  fit: BoxFit.cover,
                                ),
                              ),
                            ),
